<template>
    <main class="border rounded-xl gap-x-4 border-gray-200">
        <div class="border-b py-4 px-6">
            <h1 class="text-xl font-medium mb-2 py-0 my-0">Create Challenge</h1>
          </div>
        <div class="p-3">
            <button class="border rounded-md text-sm bg-gray-25 text-gray-800 px-4 py-2" @click="router.back()">Go back</button>
        </div>
  ...
  const { createChallenge, loading, challengeObj } = useCreateChallenge();
